...
%     [cache_gpu. chirp_forward2, cache_gpu. chirp_backward2]   = ChirpAS(p,p.dis_modu2ccd);
    %cache for frsnel propagation between object and modulator
    [cache_gpu]                                               = ChirpFresnel(p,cache_gpu,p.dx_obj./p.lambda,p. dis_modu2ccd./p.lambda);
%     [cache_gpu]  = ChirpFresnel2(p,cache_gpu,p.dis_modu2ccd);
    %cache for Dfrsnel propagation between object and modulator
    % [cache_gpu]                                               = ChirpDFresnel(cache_gpu,p,p.dx_modu,p.dx_dp,p.dis_modu2ccd);
    %-------------------------------------
